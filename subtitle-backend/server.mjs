...
import correctionRoute from "./routes/correctionRoute.js";
import activityParameters from "./routes/activityParameters.js";
// import subtitleRoutes from "./routes/subtitleRoutes.js";

const app = express();
// const correctionRoute = require("./routes/correctionRoute.js");
(async () => {
  try {
    ...
    app.use("/api", activityParameters);
