...
export default function Prediction10Days() {
  ...
  const languageSetList = useMemo(() => {
    ...
    return list;
  }, [activities, targetLangKey, fromDate, toDate, filterLagna]);
  ...
  //       // Re-select the updated item so its status prop updates:
  //       if (selectedLanguageSet) {
  //         const updated = activities.find(
  //           (a) =>
  //             a.id === selectedLanguageSet.activity.id &&
  //             a[targetLangKey] === selectedLanguageSet.primaryLangKey
  //         );
  //         if (updated) {
  //           handleSelectLanguageSet({
  //             activity: updated,
  //             primaryLangKey: selectedLanguageSet.primaryLangKey,
  //             targetLangKey,
  //           });
  //         }
  //       }
