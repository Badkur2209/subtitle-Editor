...
export default function TextBased() {
  ...
  const [mksabbChoice, setMksabbChoice] = useState<"same" | "different">(
    "same"
  );
  ...
  useEffect(() => {
    if (selected && loaded) {
      ...
      setMksabbChoice(selected.mksabb === "different" ? "different" : "same");
    }
  ...
  const filteredActivities = activities.filter((a) => {
    ...
    const targetName = getActivityName(a, targetLangKey);
    ...
    <div className="p-6">
      ...
      {selectedLink && (
        <div className="mb-4">
          <h3 className="font-semibold mb-2">Related Video</h3>
          {(() => {
            const start = timeStringToSeconds(selected.MKSA_Start);
            const end = timeStringToSeconds(selected.MKSA_End);
        ...
        <div className="flex gap-6">
          ...
          <div className="w-1/3">
            <h3 className="font-semibold mb-2">
              Activities for Correction({filteredActivities.length})
            </h3>
                    ...
                    <div className="flex flex-col text-sm gap-1">
                      <div className="flex item-center gap-2">
                        ...
                        <span className="font-semibold">
                          {index + 1}.{" "}
                          {getActivityName(activity, targetLangKey).substring(
                            0,
                            50
                          )}
                          {getActivityName(activity, targetLangKey).length > 50
                            ? "..."
                            : ""}
                        </span>
                      </div>
                ...
                <div className="flex gap-8">
                  {/* <div className="flex-1">
                    <h3 className="text-lg font-semibold mb-2">
                      Original ({getPlainLangName(targetLangKey)})
                    </h3>
                    ...
                    <textarea
                      ...
                      value={getActivityData(
                        selected,
                        LANG_KEYS.find((l) => l.key === targetLangKey)?.dataKey
                      )}
                    />
                  </div> */}
      ...
      {loaded && selected && (
        <div className="mt-4">
          ...
          {/* MKSABB Radio */}
          <div className="mt-4">
            <span className="font-medium mr-4">MKSABB:</span>
            <label className="inline-flex items-center mr-6">
              <input
                type="radio"
                name="mksabb"
                value="same"
                checked={mksabbChoice === "same"}
                onChange={() => setMksabbChoice("same")}
            ...
            <label className="inline-flex items-center">
              <input
                ...
                name="mksabb"
                value="different"
                checked={mksabbChoice === "different"}
                onChange={() => setMksabbChoice("different")}
                className="form-radio text-blue-600"
              />
