...
export default function Prediction10Days() {
  ...
  const handleLoad = async () => {
    setLoading(true);
    try { const response = await fetch("http://localhost:5000/api/predictions/predictions");
  ...
  return (
    <div className="p-6">
      <h2 className="text-xl font-bold mb-4">prediction 10 days Translation Editor</h2>
