...
export const SidebarTrigger = ({ className }: { className?: string }) => {
  ...
  return (
    <button
      ...
      className={clsx("text-2xl focus:outline-none", className)}
...
export const Sidebar = ({
  ...
  return (
    <aside
      className={clsx(
        "z-50 lg:z-auto", // increased z-index
...
export const SidebarOverlay = () => {
  ...
  if (state === "closed" || typeof window === "undefined") return null;
...
// Custom sidebar UI building blocks
export const SidebarContent = ({ children, className = "" }: any) => (
  <div className={clsx("p-4 flex flex-col h-full", className)}>{children}</div>
);

export const SidebarGroup = ({ children }: any) => <div>{children}</div>;

export const SidebarGroupContent = ({ children }: any) => <div>{children}</div>;

export const SidebarMenu = ({ children, className = "" }: any) => (
...
export const SidebarMenuButton = ({
  ...
  asChild ? (
    ...
    <button className={clsx("w-full text-left", className)}>{children}</button>
  );
